`include "/home/hatthanh/schoolwork/KLTN/RTL/code_initial/_parameter.v"

module Scan_Core_Engine_instr
(
    input clk,
    input reset,
    ...
    // Internal Registers (copied from original)
