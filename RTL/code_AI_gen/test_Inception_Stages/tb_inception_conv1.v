...
module tb_inception_conv1;
    ...
    initial begin
        ...
        $readmemh("../test_BaseInceptionBlock_Full/weights_and_io/inception_conv1_k1_weight_q312.mem", dut.weights_c1);
