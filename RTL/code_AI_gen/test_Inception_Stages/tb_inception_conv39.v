...
module tb_inception_conv39;
    ...
    initial begin
        ...
        $readmemh("../test_BaseInceptionBlock_Full/weights_and_io/inception_conv4_k39_weight_q312.mem", dut.dut.weights_c);
