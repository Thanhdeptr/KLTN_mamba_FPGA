...
module tb_inception_final;
    ...
    initial begin
        ...
        $readmemh("../../../ITMN/golden_vectors/rtl_mem/inception_stage/tensors/10_concat_prebn_q312.mem", input_mem);
        ...
        $readmemh("../test_BaseInceptionBlock_Full/weights_and_io/inception_bn_weight_q312.mem", dut.bn_weight);
        $readmemh("../test_BaseInceptionBlock_Full/weights_and_io/inception_bn_bias_q312.mem", dut.bn_bias);
        $readmemh("../test_BaseInceptionBlock_Full/weights_and_io/inception_bn_running_mean_q312.mem", dut.bn_mean);
        $readmemh("../test_BaseInceptionBlock_Full/weights_and_io/inception_bn_running_var_q312.mem", dut.bn_var);
        ...
        token_count = 0;
        out_count = 0;
        while (token_count < TOKENS_CHECK) begin
            @(posedge clk);
        ...
        timeout = 0;
        while ((out_count < TOKENS_CHECK) && (timeout < 20)) begin
            @(posedge clk);
            timeout = timeout + 1;
        end
