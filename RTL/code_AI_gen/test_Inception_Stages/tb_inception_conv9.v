...
module tb_inception_conv9;
    ...
    initial begin
        ...
        $readmemh("../test_BaseInceptionBlock_Full/weights_and_io/inception_conv2_k9_weight_q312.mem", dut.dut.weights_c);
